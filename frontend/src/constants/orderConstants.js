...
export const ORDER_DETAILS_REQUEST = "SINGLE_ORDER_REQUEST";
export const ORDER_DETAILS_SUCCESS = "SINGLE_ORDER_SUCCESS";
export const ORDER_DETAILS_FAIL = "SINGLE_ORDER_FAIL";
